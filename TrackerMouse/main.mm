    ...
    @autoreleasepool {
        ...
        while (!isClickInitialised) {
            ...
            if (waitKey(10) == 32) {
                ...
                // Detect ball in subregion of frame to set threshold for detection
        ...
        // Initialise colour model for track-controller
        ...
        // Initialise cursor object and parameters
        ...
        while (source.isOpen) {
            ...
            // Look for click ball in subregion
            ...
            if (isClick) {
                ...
                if (clickCount >= clickSensitivity) {
                    ...
                    // If detection should register as an event, apply click
